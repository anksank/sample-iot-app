sap.ui.define([
	...
	"sample/model/formatter"
], function (Controller, formatter) {
	"use strict";

	return Controller.extend("sample.controller.ThingPage", {
		formatter: formatter,
		onInit: function () {
		...
		_readDetailsService: function (oDetailsModel, sThingId) {
			...
			oDetailsModel.read("/Things('" + sThingId + "')", {
				urlParameters: {
					"$expand": "DYN_ENT_demo_tenant01_com_connected_silos__SILO_TIME_SERIES,DYN_ENT_demo_tenant01_com_connected_silos__SILO_METADATA,DYN_ENT_demo_tenant01_com_connected_silos__Image,DYN_ENT_demo_tenant01_com_connected_silos__Material"
				},
